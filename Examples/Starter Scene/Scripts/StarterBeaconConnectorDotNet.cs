...
{
    public class StarterBeaconConnectorDotNet : IBeaconConnector
    {
        ...
        private BeaconOptions _beaconOptions;

        public void SetBeaconOptionsAndConnect(BeaconOptions beaconOptions)
        {
        ...
        public async void ConnectAccount()
        {
            BeaconDappClient = (DappBeaconClient) BeaconClientFactory
                .Create<IDappBeaconClient>(_beaconOptions, new MyLoggerProvider());
