...
namespace Tezos.StarterScene
{
    public class TestTransferTezos : MonoBehaviour
    {
        ...
        private void Start()
        {
            _button.onClick.AddListener(OnTransferTezosButtonClicked);
        }

        private void OnDestroy()
        {
            _button.onClick.RemoveListener(OnTransferTezosButtonClicked);
        }

        private void OnTransferTezosButtonClicked()
        {
